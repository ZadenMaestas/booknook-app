...
import { Book, ReadingProgress } from '../database';
...
router.use('*', requirePermission('books'));
...
router.get('/books/file/:id', async c => {
...
router.post('/books/:id/progress', async c => {
...
router.patch('/books/:id/status', async c => {
